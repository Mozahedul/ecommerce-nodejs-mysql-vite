...
const Special = props => {
  ...
  return (
    <div
      ...
      className="shadow-md mt-1 w-1/2 md:w-1/3 p-6 bg-white last:mr-0 flex flex-col justify-between transition-all duration-500 hover:shadow-2xl hover:cursor-pointer"
    >
      <div>
